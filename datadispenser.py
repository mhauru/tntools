...
The goal is a user experience wheree one just tells datadispenser "I want
...
filelogger is a logger object for the python logging module, that writes
...
The first argument is a path to a database, i.e., a folder in which the
